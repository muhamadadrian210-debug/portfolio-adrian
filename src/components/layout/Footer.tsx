    ...
    <footer role="contentinfo" style={{ background: "#051018", padding: "100px 0 60px" }}>
      <div className="container" style={{ maxWidth: 780, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", gap: 28, textAlign: "center" }}>
        ...
        <p style={{ color: "#cbd5e1", fontSize: "1rem", maxWidth: 680, margin: 0, lineHeight: 1.8 }}>
          Sivilize Corp | Solusi digital terpercaya untuk bisnis, produk, dan transformasi web. Semua layanan dibangun untuk mendukung growth dan operasional digital Anda.
        </p>
        <p style={{ color: "#7f8fa4", fontSize: "0.88rem", margin: 0 }}>&copy; 2024 Sivilize Corp. All rights reserved.</p>
      </div>
    </footer>
  );
}
...
export function SocialLinks() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 18, flexWrap: "wrap", justifyContent: "center" }}>
      ...
      <a href="mailto:hello@sivilizecorp.vercel.app" aria-label="Email" style={socialStyle}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={iconStyle}><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" /></svg></a>
    </div>
  );
}
